// asp/skills/index.js — the A2MCP skill registry. Each skill is a thin adapter
// over the engine exposing { name, title, description, priceUsdt, inputSchema, run }.
...
/** Public manifest describing every skill (for the service page + MCP tool list). */
